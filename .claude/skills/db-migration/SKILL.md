...
6. Never run `prisma migrate deploy` or `prisma migrate reset` as part of this flow — those are explicit, human-confirmed, separate actions (see `.claude/agents/prisma-migrator.md`).
