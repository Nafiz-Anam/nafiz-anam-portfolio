...
export function WorkGrid() {
  return (
    <section id="work" className="dark bg-texture-lines bg-background px-6 py-16 text-foreground lg:px-16">
      <div className="mx-auto max-w-[1800px]">
        ...
        <div className="mt-10 flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
            <div className="h-[420px] sm:col-span-2">
              <ProjectCard />
            </div>
            <div className="h-[420px] sm:col-span-1">
              <ProjectCard />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
            ...
            <div className="h-[340px] sm:col-span-1">
              <ProjectCard />
            </div>
            <div className="h-[340px] sm:col-span-2">
              <ProjectCard />
            </div>
          </div>
